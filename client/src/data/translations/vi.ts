...
export const VI_GAMES: Record<string, GameTranslation> = {
  'snake': {
    title: 'Google Rắn săn mồi',
    description: 'Chơi trò chơi Rắn săn mồi cổ điển được tích hợp ngay trong Google Tìm kiếm. Điều khiển con rắn ngày càng dài để ăn táo trong khi tránh tường và đuôi của chính nó. Bạn sống càng lâu, trò chơi càng nhanh và khó hơn.\n\nBan đầu phổ biến trên điện thoại Nokia cuối những năm 1990, Rắn săn mồi đã trở thành một trong những trò chơi điện tử được nhận biết nhất trong lịch sử.',
  ...
  'pacman': {
    ...
    description: 'Chơi trò PAC-MAN huyền thoại được tạo lại dưới dạng Doodle Google có thể chơi được nhân kỷ niệm 30 năm vào năm 2010. Điều hướng qua mê cung biểu tượng, ăn hết tất cả các chấm và bắt ma bằng viên sức mạnh.\n\nĐây là Doodle Google đầu tiên có thể chơi được và trở thành hiện tượng văn hóa — ước tính một tỷ người đã chơi trong ba ngày đầu tiên.',
  ...
  'doodle-google-15th': {
    ...
    controls: 'Nhấp hoặc nhấn phím cách để vung gậy vào piñata. Hãy căn thời gian cho những cú đánh của bạn để phá vỡ nó và rải kẹo khắp nơi. Thu thập càng nhiều càng tốt!',
  },
  'rubiks-cube': {
  ...
  'garden-gnomes': {
    ...
    controls: 'Nhấp và giữ để đặt góc phóng, sau đó thả ra để ném chú lùn. Bạn giữ càng lâu thì càng có nhiều sức mạnh. Hãy cố gắng đạt được khoảng cách tối đa!',
  },
  'halloween': {
  ...
  'doodle-earth-day': {
    ...
    controls: 'Sử dụng các phím mũi tên hoặc nhấp chuột để hướng dẫn con ong giữa các bông hoa. Đậu lên những bông hoa để thu thập phấn hoa, sau đó ghé thăm những bông hoa khác để thụ phấn cho chúng. Giúp cả khu vườn nở hoa!',
  },
  'magic-cat-academy-2': {
  ...
  'google-maps-snake': {
    ...
    controls: 'Sử dụng các phím mũi tên để điều hướng xe của bạn qua các đường phố trong thành phố. Đón khách để phát triển lâu hơn. Tránh đánh chính mình hoặc lái xe ra khỏi bản đồ!',
  },
  'google-earth': {
    title: 'Google Earth',
  ...
  'google-freecell': {
    ...
    controls: 'Bấm để di chuyển thẻ giữa các cột, ô trống và cọc móng. Xây dựng các cột có màu xen kẽ giảm dần. Di chuyển các thẻ đến các nền theo thứ tự tăng dần theo chất.',
  },
  'google-memory': {
  ...
  'google-word-coach': {
    ...
    controls: 'Bấm vào câu trả lời đúng từ các tùy chọn được cung cấp cho mỗi câu hỏi từ. Ghi điểm cho mỗi câu trả lời đúng và xây dựng chuỗi của bạn.',
  },
  'google-spinner': {
  ...
  'google-dice-roller': {
    ...
    controls: 'Nhấp vào "Roll" để ném xúc xắc. Điều chỉnh số lượng xúc xắc và mặt bằng cách sử dụng các điều khiển. Kết quả được hiển thị với hình ảnh động cuộn tròn thỏa mãn.',
  },
  'google-timer': {
    title: 'Google Timer',
  ...
  'do-a-barrel-roll': {
    ...
    controls: 'Nhấp vào nút để kích hoạt hoạt ảnh cuộn thùng. Toàn bộ trang sẽ quay 360 độ. Nhấp nhiều lần để có được niềm vui lăn lộn liên tục!',
  },
  'google-askew': {
  ...
  'google-arts-culture-face-match': {
    ...
    controls: 'Cho phép truy cập máy ảnh và chụp ảnh tự sướng bằng cách nhấp vào nút chụp. AI sẽ quét các bộ sưu tập của bảo tàng và hiển thị tác phẩm nghệ thuật phù hợp nhất với bạn cùng với lịch sử của bức tranh.',
  },
  ...
  'google-maps-pac-man': {
    ...
    controls: 'Sử dụng các phím mũi tên để hướng dẫn PAC-MAN đi qua các con đường trong thành phố thực. Ăn tất cả các dấu chấm trong khi tránh ma. Lấy những viên năng lượng để lật ngược tình thế với những kẻ truy đuổi bạn!',
  },
  'google-whirlybird': {
