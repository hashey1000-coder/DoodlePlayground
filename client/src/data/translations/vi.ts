...
export const VI_GAMES: Record<string, GameTranslation> = {
  ...
  'pangolin-love': {
    ...
    description: 'Cuộc phiêu lưu Lễ Tình Nhân đầy quyến rũ, nơi bạn làm sô-cô-la praline để giúp chú tê tê nhút nhát tỏ tình. Theo dõi công thức qua bốn chương.\n\nDoodle này đã nâng cao nhận thức về tê tê trên toàn thế giới. Các tổ chức bảo tồn thiên nhiên báo cáo sự gia tăng đáng kể trong quyên góp sau khi Doodle được phát hành.',
  },
  'doodle-cricket-game': {
  ...
  'google-freecell': {
    ...
    description: 'Thử thách tư duy chiến lược trong trò chơi bài mà hầu như mọi ván đều có thể giải được. Sử dụng bốn ô trống làm bộ nhớ tạm để di chuyển các lá bài.\n\nFreeCell nổi bật giữa các biến thể xếp bài khác vì hầu như mọi ván đều có thể thắng — đây hoàn toàn là trò chơi về kỹ năng và lập kế hoạch cẩn thận.',
  },
  'google-cricket': {
    title: 'Google Cricket',
    description: 'Đánh bóng biên với các nhân vật côn trùng dễ thương trong trò chơi cricket vui nhộn này. Nhấp đúng thời điểm để đánh bóng qua sân.\n\nCricket, với khoảng 2,5 tỷ người hâm mộ, là môn thể thao phổ biến thứ hai trên thế giới.',
  },
  'google-memory': {
  ...
  'google-word-coach': {
    ...
    description: 'Mở rộng vốn từ vựng với câu đố về định nghĩa, từ đồng nghĩa và mối quan hệ từ ngữ. Chọn đáp án đúng và học từ mới.\n\nGoogle Word Coach ban đầu xuất hiện trong kết quả tìm kiếm dành cho người dùng không nói tiếng Anh bản ngữ, giúp cải thiện từ vựng tiếng Anh một cách thú vị.',
  },
  'google-spinner': {
  ...
  'google-pac-man': {
    ...
    description: 'Doodle Google PAC-MAN kinh điển có sẵn trên elgooG, để bạn có thể chơi trò arcade biểu tượng này bất cứ lúc nào.\n\nPAC-MAN với doanh thu hơn 14 tỷ đô la vẫn là trò arcade có lợi nhuận cao nhất mọi thời đại.',
  },
  'google-mirror': {
  ...
  'doodle-solitaire': {
    ...
    description: 'Chơi xếp bài Klondike như một phần trong chiến dịch "Ở Nhà và Chơi" năm 2020 của Google. Xây dựng các chồng từ Át đến Già.\n\nTrong đại dịch COVID-19 vào tháng 4 năm 2020, Google đã tái phát hành các trò chơi phổ biến để giúp mọi người giải trí trong thời gian ở nhà.',
  },
  ...
  'indigenous-stickball': {
    ...
    description: 'Tìm hiểu về stickball, một trong những môn thể thao đồng đội lâu đời nhất ở Bắc Mỹ, trong Doodle được minh họa tuyệt đẹp này.\n\nStickball đã được chơi từ trước khi tiếp xúc với châu Âu bởi người bản địa Bắc Mỹ và có chức năng vừa là thể thao cạnh tranh vừa là nghi lễ truyền thống.',
  },
  'marie-tharp-doodle': {
    title: 'Tôn Vinh Marie Tharp',
    description: 'Khám phá đáy đại dương cùng nhà địa chất tiên phong Marie Tharp trong Doodle tương tác này. Lập bản đồ các dãy núi dưới biển và cung cấp bằng chứng cho sự trôi dạt lục địa.\n\nMarie Tharp đã tạo ra bản đồ đầy đủ đầu tiên về đáy đại dương và cung cấp bằng chứng then chốt cho thuyết kiến tạo mảng.',
  },
  ...
  'google-science-journal': {
    ...
    description: 'Biến thiết bị của bạn thành phòng thí nghiệm khoa học di động. Sử dụng cảm biến điện thoại thông minh để đo và ghi lại ánh sáng, âm thanh, gia tốc và nhiều hơn nữa.\n\nGoogle Nhật Ký Khoa Học dân chủ hóa khám phá khoa học bằng cách biến điện thoại thông minh thành công cụ đo lường chính xác.',
  },
  'google-maps-pac-man': {
    title: 'Google Maps PAC-MAN',
    description: 'Chơi PAC-MAN trên đường phố thật trong sự kết hợp huyền thoại với Google Maps. Di chuyển dọc theo đường phố thực, ăn các chấm và tránh ma.\n\nBan đầu được phát hành như trò đùa Cá tháng Tư của Google Maps năm 2015, trò chơi này biến đường phố bất kỳ thành mê cung PAC-MAN.',
  },
  'google-whirlybird': {
