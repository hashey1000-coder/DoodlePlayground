export const ID_TRIVIA: Record<string, string> = {
  ...
  '2048': '2048 diciptakan oleh pengembang Italia berusia 19 tahun Gabriele Cirulli dalam satu akhir pekan pada Maret 2014. Dalam seminggu sudah memiliki 4 juta pemain.',
  'tetris': 'Tetris dirancang oleh insinyur Soviet Alexey Pajitnov pada 1984 di komputer Elektronika 60. Namanya menggabungkan "tetra" (Yunani untuk empat) dengan tenis.',
  'pong': 'Pong adalah game arcade pertama Atari dan video game pertama yang sukses secara komersial. Desainer Al Alcorn membuatnya sebagai latihan; menjadi fenomena budaya.',
  'breakout': 'Breakout dirancang tahun 1976 oleh Nolan Bushnell dan Steve Bristow; prototipe perangkat kerasnya dibangun oleh Steve Jobs dan Steve Wozniak hanya dalam empat hari.',
  'sudoku': 'Meskipun namanya Jepang, Sudoku ditemukan di AS oleh Howard Garns pada 1979 sebagai "Number Place". Demam global dimulai pada 2004.',
  'word-search': 'Teka-teki pencarian kata ditemukan oleh Norman E. Gibat pada 1968 dan pertama kali diterbitkan di buletin kecil Oklahoma bernama Selenby Digest.',
  'word-scramble': 'Word Scramble memanfaatkan keunikan otak: dapat mengenali kata dengan huruf tengah yang diacak jika huruf pertama dan terakhir tetap di tempatnya.',
  'connect-four': 'Connect Four diselesaikan secara matematis pada 1988. Pemain pertama selalu bisa memaksa kemenangan dengan memulai dari kolom tengah.',
  'sliding-puzzle': 'Puzzle 15 memicu kegilaan dunia pada 1880-an. Secara matematis, tepat setengah dari semua susunan acak tidak mungkin diselesaikan.',
  'flappy-bird': 'Flappy Bird dibuat oleh pengembang Vietnam Dong Nguyen dalam beberapa hari pada 2013, menghasilkan $50.000 per hari dari iklan di puncaknya.',
  'space-invaders-online': 'Space Invaders (1978) menyebabkan kekurangan koin 100 yen nasional di Jepang. Mendorong industri game Jepang hingga 50 miliar yen.',
  'asteroids': 'Asteroids (1979) adalah kabinet arcade terlaris Atari dengan lebih dari 70.000 unit.',
  'frogger': 'Frogger (1981) terjual lebih dari 20 juta kopi dan dianggap sebagai salah satu komentar lingkungan paling awal dalam sejarah game.',
  'galaga': 'Galaga (1981) memiliki "trik" terkenal: sengaja membiarkan Boss Galaga menangkap pesawatmu, lalu tembak bos untuk mendapatkannya kembali dan bertarung sebagai pesawat ganda.',
  'brick-breaker': 'Brick Breaker berevolusi dari Breakout Atari (1976), yang sendirinya berasal dari Pong. Mekanik bola-memecah-batu tetap menjadi template fundamental selama hampir 50 tahun.',
  'stack-tower': 'Stack Tower memanfaatkan hasrat otak akan presisi: tumpukan hampir sempurna terasa memuaskan, sedikit meleset terasa menghancurkan.',
  'reaction-time': 'Waktu reaksi rata-rata manusia sekitar 250 milidetik. Atlet mencapai sekitar 150ms. Pembalap F1 bisa bereaksi dalam 100ms saja.',
  'whack-a-mole': 'Whac-A-Mole (awalnya "Mogura Taiji") ditemukan oleh pengembang Jepang TOGO pada 1975. Mesin aslinya menggunakan palu karet asli.',
  'dots-and-boxes': 'Dots and Boxes ditemukan oleh matematikawan Prancis Édouard Lucas pada 1889. Di balik tampilannya yang kekanak-kanakan tersembunyi teori permainan kombinatorial yang dalam.',
  'reversi': 'Reversi ditemukan di Inggris pada 1883. Versi modern Othello (1971) membawa slogan "satu menit untuk belajar, seumur hidup untuk menguasai".',
};
