export const NL_TRIVIA: Record<string, string> = {
  ...
  'pacman': 'Googles Pac-Man-Doodle uit 2010 was zo populair dat spelers naar schatting 4,8 miljoen uur eraan besteedden, wat de wereldeconomie ongeveer 120 miljoen dollar aan verloren productiviteit kostte.',
  ...
  'doodle-cricket-game': 'Cricket is de op één na populairste sport ter wereld met naar schatting 2,5 miljard fans, voornamelijk in Zuid-Azië, Australië en Engeland.',
  'doodle-kids-coding': 'De Coding for Carrots-doodle vierde 50 jaar programmeertalen voor kinderen, teruggaand tot Logo, ontwikkeld in 1967, waarmee kinderen een schildpad konden programmeren om te tekenen.',
  ...
  'rise-of-the-half-moon': 'Rise of the Half Moon was Googles eerste geserialiseerde Doodle-spel met meerdere hoofdstukken, waarbij maandelijks nieuwe verhaaldelen verschenen als een episodisch RPG-avontuur.',
  'chinese-new-year-snake': 'In de Chinese dierenriem worden mensen die in het Jaar van de Slang zijn geboren beschouwd als wijs, raadselachtig en intuïtief — beroemde "slangen" zijn onder andere Oprah Winfrey en J.K. Rowling.',
  ...
  'great-ghoul-duel-2': 'Great Ghoul Duel was Googles allereerste multiplayer Doodle-spel, waarbij spelers wereldwijd in real-time als spokenteams streden om de meeste geestvlammen te verzamelen.',
  ...
  'rise-of-the-half-moon-november': 'Tabletop-RPG\'s zoals de spellen die Rise of the Half Moon inspireerden, gaan terug tot Dungeons & Dragons uit 1974, dat aanvankelijk door elke grote speluitgever werd afgewezen.',
  'rise-of-the-half-moon-december': 'De "halve maan" symboliseert in veel culturen de balans tussen licht en donker — in gamedesign is deze dualiteit een klassiek verhalend middel voor heldenverhalen.',
  'rise-of-the-half-moon-january': 'Episodische game-releases werden populair met Telltale\'s The Walking Dead in 2012, wat bewees dat spelers maandelijks zouden terugkeren voor verhaalgedreven gameplay.',
  ...
  '2048': '2048 werd gemaakt door de 19-jarige Italiaanse ontwikkelaar Gabriele Cirulli in één weekend in maart 2014. Binnen een week had het 4 miljoen spelers.',
  'tetris': 'Tetris werd in 1984 ontworpen door de Sovjet-ingenieur Alexey Pajitnov op een Elektronika 60-computer. De naam combineert "tetra" (Grieks voor vier) met tennis.',
  'pong': 'Pong was Atari\'s eerste arcadespel en het eerste commercieel succesvolle videospel. Ontwerper Al Alcorn maakte het als trainingsoefening; het werd een cultureel fenomeen.',
  'breakout': 'Breakout werd in 1976 ontworpen door Nolan Bushnell en Steve Bristow; het hardware-prototype werd door Steve Jobs en Steve Wozniak in slechts vier dagen gebouwd.',
  'sudoku': 'Ondanks de Japanse naam werd Sudoku in 1979 in de VS uitgevonden door Howard Garns als "Number Place". De wereldwijde rage begon in 2004.',
  'word-search': 'De woordzoeker werd in 1968 uitgevonden door Norman E. Gibat en voor het eerst gepubliceerd in een klein Oklahoma-nieuwsblad genaamd Selenby Digest.',
  'word-scramble': 'Word Scramble maakt gebruik van een fascinerend fenomeen: de hersenen kunnen woorden herkennen met geschudde middelste letters als de eerste en laatste op hun plaats blijven.',
  'connect-four': 'Vier op een rij werd in 1988 wiskundig opgelost. De eerste speler kan altijd winnen door in de middelste kolom te beginnen.',
  'sliding-puzzle': 'De 15-puzzel veroorzaakte een wereldwijde rage in de jaren 1880. Wiskundig gezien is precies de helft van alle geschudde arrangementen onoplosbaar.',
  'flappy-bird': 'Flappy Bird werd in 2013 door de Vietnamese ontwikkelaar Dong Nguyen in een paar dagen gemaakt en verdiende op zijn hoogtepunt $50.000 per dag aan advertentie-inkomsten.',
  'space-invaders-online': 'Space Invaders (1978) veroorzaakte een nationaal munttekort van 100 yen in Japan. Het stuwde de Japanse game-industrie naar 50 miljard yen.',
  'asteroids': 'Asteroids (1979) was Atari\'s bestverkochte arcadekast met meer dan 70.000 eenheden.',
  'frogger': 'Frogger (1981) verkocht meer dan 20 miljoen exemplaren en wordt beschouwd als een van de eerste milieucommentaren in de gamegeschiedenis.',
  'galaga': 'Galaga (1981) heeft een beroemde "truc": laat opzettelijk een Boss Galaga je schip vangen, schiet dan de boss neer om het terug te krijgen en vecht als dubbel schip.',
  'brick-breaker': 'Brick Breaker evolueerde uit Atari\'s Breakout (1976), dat zelf uit Pong voortkwam. De bal-breekt-stenen-mechaniek is al bijna 50 jaar een fundamenteel sjabloon.',
  'stack-tower': 'Stack Tower speelt in op het verlangen van de hersenen naar precisie: een bijna perfecte stapel voelt belonend, een lichte misser voelt verwoestend.',
  'reaction-time': 'De gemiddelde menselijke reactietijd is ongeveer 250 milliseconden. Atleten halen ongeveer 150ms. F1-coureurs kunnen in slechts 100ms reageren.',
  'whack-a-mole': 'Whac-A-Mole (oorspronkelijk "Mogura Taiji") werd in 1975 uitgevonden door de Japanse ontwikkelaar TOGO.',
  'dots-and-boxes': 'Kamertje verhuren werd in 1889 uitgevonden door de Franse wiskundige Édouard Lucas. Achter het kinderlijke uiterlijk schuilt diepe combinatorische speltheorie.',
  'reversi': 'Reversi werd in 1883 in Engeland uitgevonden. De moderne Othello-versie (1971) draagt de slogan "een minuut om te leren, een leven om te beheersen".',
};
