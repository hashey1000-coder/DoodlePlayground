export const SV_TRIVIA: Record<string, string> = {
  ...
  '2048': '2048 skapades av den 19-åriga italienska utvecklaren Gabriele Cirulli på en enda helg i mars 2014. Inom en vecka hade det 4 miljoner spelare.',
  'tetris': 'Tetris designades av den sovjetiska ingenjören Alexey Pajitnov 1984 på en Elektronika 60-dator. Namnet kombinerar "tetra" (grekiska för fyra) med tennis.',
  'pong': 'Pong var Ataris första arkadspel och det första kommersiellt framgångsrika videospelet. Designern Al Alcorn skapade det som en träningsövning — det blev ett kulturellt fenomen.',
  'breakout': 'Breakout designades 1976 av Nolan Bushnell och Steve Bristow; hårdvaruprototypen byggdes av Steve Jobs och Steve Wozniak på bara fyra dagar.',
  'sudoku': 'Trots sitt japanska namn uppfanns Sudoku i USA av Howard Garns 1979 som "Number Place". Den globala galenskapen började 2004.',
  'word-search': 'Ordsökspusslet uppfanns av Norman E. Gibat 1968 och publicerades först i ett litet nyhetsbrev från Oklahoma kallat Selenby Digest.',
  'word-scramble': 'Word Scramble utnyttjar en fascinerande egenskap: hjärnan kan känna igen ord med blandade mittenbokstäver om den första och sista bokstaven förblir på plats.',
  'connect-four': 'Fyra i rad löstes matematiskt 1988. Den första spelaren kan alltid tvinga en vinst genom att börja i mittkolumnen.',
  'sliding-puzzle': '15-pusslet utlöste en världsomspännande mani på 1880-talet. Matematiskt är exakt hälften av alla blandade arrangemang omöjliga att lösa.',
  'flappy-bird': 'Flappy Bird skapades av den vietnamesiska utvecklaren Dong Nguyen på några dagar 2013 och tjänade 50 000 dollar per dag i annonsinkomster.',
  'space-invaders-online': 'Space Invaders (1978) orsakade en nationell brist på 100-yenmynt i Japan. Det drev den japanska spelindustrin till 50 miljarder yen.',
  'asteroids': 'Asteroids (1979) var Ataris bästsäljande arkadskåp med över 70 000 enheter.',
  'frogger': 'Frogger (1981) sålde över 20 miljoner exemplar och anses vara en av spelhistoriens första miljökommentarer.',
  'galaga': 'Galaga (1981) har ett berömt "trick": låt avsiktligt en Boss Galaga fånga ditt skepp, skjut sedan ner bossen för att återfå det och slåss som dubbelskepp.',
  'brick-breaker': 'Brick Breaker utvecklades från Ataris Breakout (1976), som i sin tur kom från Pong. Boll-förstör-klossar-mekaniken har varit en grundläggande mall i nästan 50 år.',
  'stack-tower': 'Stack Tower utnyttjar hjärnans längtan efter precision: en nästan perfekt stapel känns belönande, en liten miss känns förödande.',
  'reaction-time': 'Genomsnittlig mänsklig reaktionstid är cirka 250 millisekunder. Idrottare når cirka 150ms. F1-förare kan reagera på bara 100ms.',
  'whack-a-mole': 'Whac-A-Mole (ursprungligen "Mogura Taiji") uppfanns av den japanska utvecklaren TOGO 1975.',
  'dots-and-boxes': 'Prickar och lådor uppfanns av den franske matematikern Édouard Lucas 1889. Bakom det barnsliga utseendet döljer sig djup kombinatorisk spelteori.',
  'reversi': 'Reversi uppfanns i England 1883. Den moderna Othello-versionen (1971) bär sloganen "en minut att lära, ett liv att bemästra".',
};
