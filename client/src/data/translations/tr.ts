...
export const TR_GAMES: Record<string, GameTranslation> = {
  ...
  'pacman': {
    ...
    description: '2010\'da 30. yıl dönümü için oynanabilir bir Google Doodle olarak yeniden yaratılan efsanevi PAC-MAN oyununu oynayın. İkonik labirenti geçin, tüm noktaları yiyin ve güç haplarıyla hayaletleri yakalayın.\n\nBu, Google\'ın ilk oynanabilir Doodle\'ıydı ve kültürel bir fenomene dönüştü — ilk üç günde tahminen bir milyar kişi oynadı.',
  ...
  'chrome-dino': {
    title: 'Chrome Dino (İnternetsiz Oyun)',
    description: 'Chrome\'un çevrimdışı sayfasındaki ünlü T-Rex dinozor koşucusu — artık her zaman oynanabilir. Kaktüslerin üzerinden atlayın ve pterodaktillerin altından geçin.\n\nChrome Dino oyunu 2014\'te Google tasarımcısı Sebastien Gabriel tarafından oluşturuldu. Ayda yaklaşık 270 milyon oyunla dünyanın en çok oynanan oyunlarından biri oldu.',
  ...
  'doodle-roswell': {
    ...
    controls: 'Onlarla etkileşime geçmek için sahnedeki nesnelere tıklayın. Farklı konumlara dağılmış tüm uzay gemisi parçalarını bulun. Yeni alanların kilidini açmak için basit bulmacaları çözün.',
  },
  'mothers-day-2013': {
  ...
  'eiji-tsuburaya': {
    ...
    controls: 'Hareket etmek için ok tuşlarını, saldırmak için boşluk çubuğunu kullanın. Canavarları özel efektli ışınlarla vurarak yenin. Tüm aşamaları tamamlayın!',
  },
  'pony-express': {
  ...
  'google-freecell': {
    ...
    controls: 'Kartları sütunlar, boş hücreler ve temel yığınları arasında taşımak için tıklayın. Azalan alternatif renklerde sütunlar oluşturun. Kartları takımlara göre artan sırada temellere taşıyın.',
  },
  'google-memory': {
  ...
  'google-word-coach': {
    ...
    controls: 'Her kelime sorusu için sunulan seçeneklerden doğru cevaba tıklayın. Her doğru cevap için puan toplayın ve serinizi geliştirin.',
  },
  'google-spinner': {
  ...
  'google-maps-pac-man': {
    ...
    controls: 'PAC-MAN\'i gerçek şehir sokaklarında yönlendirmek için ok tuşlarını kullanın. Hayaletlerden kaçarken tüm noktaları yiyin. Durumu takipçilerinizin aleyhine çevirmek için güç topaklarını alın!',
  },
  'google-whirlybird': {
