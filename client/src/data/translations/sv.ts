...
export const SV_GAMES: Record<string, GameTranslation> = {
  'snake': {
    title: 'Google Snake',
    description: 'Spela det klassiska Snake-spelet inbyggt direkt i Google Sök. Styr din växande orm att äta äpplen medan du undviker väggar och din egen svans. Ju längre du överlever, desto snabbare och svårare blir det.\n\nUrsprungligen populärt på Nokia-telefoner i slutet av 1990-talet har Snake blivit ett av de mest igenkännliga videospelen i historien.',
  ...
  'pacman': {
    ...
    description: 'Spela det legendariska PAC-MAN-arkadspelet, återskapad som en spelbar Google Doodle för dess 30-årsjubileum 2010. Navigera genom den ikoniska labyrinten, ät alla prickar och fånga spökena med kraftpillren.\n\nDetta var den allra första spelbara Google Doodle och blev ett kulturellt fenomen — uppskattningsvis en miljard människor spelade det under de första tre dagarna.',
  ...
  'google-freecell': {
    ...
    controls: 'Klicka för att flytta kort mellan kolumner, fria celler och grundhögar. Bygg kolumner i fallande alternerande färger. Flytta korten till grunderna i stigande ordning efter färg.',
  },
  'google-memory': {
  ...
  'google-word-coach': {
    ...
    controls: 'Klicka på rätt svar från alternativen för varje ordfråga. Få poäng för varje rätt svar och bygg upp din rad.',
  },
  'google-spinner': {
  ...
  'google-askew': {
    ...
    controls: 'Titta bara på den lutade sidan och försök använda den normalt. Sök, klicka på länkar och bläddra – allt i en udda vinkel. Uppdatera för att se lutningen igen.',
  },
  'friends-easter-eggs': {
  ...
  'google-maps-pac-man': {
    ...
    controls: 'Använd piltangenterna för att guida PAC-MAN genom riktiga stadsgator. Ät alla prickar samtidigt som du undviker spöken. Ta kraftpellets för att vända på dina förföljare!',
  },
  'google-whirlybird': {
