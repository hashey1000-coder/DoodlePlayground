...
export const ES_GAMES: Record<string, GameTranslation> = {
  ...
  'basketball-2012': {
    ...
    controls: 'Mantén presionada la barra espaciadora para configurar la potencia de tu tiro, luego suéltala para disparar. Calcula el tiempo de lanzamiento para que la pelota arquee perfectamente hacia la canasta. ¡Anota tantos como puedas!',
  },
  'hurdles-2012': {
    ...
    controls: 'Alterne presionando las teclas de flecha izquierda y derecha rápidamente para ejecutar. Pulsa la barra espaciadora para saltar cada obstáculo. ¡Los saltos inoportunos te harán tropezar y te ralentizarán!',
  },
  'slalom-canoe': {
    ...
    controls: 'Utilice las teclas de flecha izquierda y derecha para dirigir la canoa. Pasa por cada puerta en orden sin perderte ninguna. ¡Apunta al menor tiempo posible!',
  },
  'soccer-2012': {
    ...
    controls: 'Utilice las teclas de flecha izquierda y derecha para sumergirse en cada dirección. Pulsa la barra espaciadora para permanecer en el centro. ¡Reacciona rápidamente al disparo del pateador para salvar!',
  },
  'robert-moog': {
    ...
    controls: 'Haga clic y arrastre las perillas para ajustar osciladores, filtros y efectos. Utilice el teclado para tocar notas. Experimente con diferentes configuraciones para crear sonidos únicos.',
  },
  'alan-turing': {
    ...
    controls: 'Haga clic en los estados y transiciones de la máquina de Turing para programarla. Presione reproducir para ejecutar la máquina y verificar si produce el resultado correcto. ¡Resuelve todos los niveles!',
  },
  'zamboni': {
    ...
    controls: 'Usa las teclas de flecha para conducir el Zamboni por la pista. Cubre cada trozo de hielo rugoso para que resurja. ¡Intenta limpiar toda la pista antes de que se acabe el tiempo!',
  },
  'doodle-crossword': {
    ...
    controls: 'Haga clic en una pista para resaltar su fila o columna. Escriba letras para completar las respuestas. Haga clic entre las pistas transversales y inferiores. ¡Completa la cuadrícula para ganar!',
  },
  'doodle-roswell': {
    ...
    controls: 'Haz clic en los objetos de la escena para interactuar con ellos. Encuentra todas las piezas de la nave espacial repartidas en diferentes lugares. Resuelve acertijos simples para desbloquear nuevas áreas.',
  },
  'mothers-day-2013': {
    ...
    controls: 'Haz clic en diferentes materiales para manualidades para decorar tu tarjeta. Elija pegatinas, dibujos y mensajes. ¡Imprime o comparte tu tarjeta terminada!',
  },
  'doodle-google-15th': {
    ...
    controls: 'Haz clic o presiona la barra espaciadora para mover el palo hacia la piñata. Calcula tus golpes para abrirlo y esparcir dulces por todas partes. ¡Recoge todo lo que puedas!',
  },
  'rubiks-cube': {
    ...
    controls: 'Haga clic y arrastre para rotar las caras del cubo. Intenta que cada lado muestre un solo color. ¡Apunta a realizar el menor número de movimientos posibles!',
  },
  'doodle-beethoven': {
    ...
    controls: 'Arrastra y suelta las barras musicales en el orden correcto. Escuche la reproducción de cada pieza cuando la haga bien. ¡Completa todas las composiciones!',
  },
  'eiji-tsuburaya': {
    ...
    controls: 'Usa las teclas de flecha para moverte y la barra espaciadora para atacar. Derrota a los monstruos golpeándolos con rayos de efectos especiales. ¡Completa todas las etapas!',
  },
  'pony-express': {
    ...
    controls: 'Presione las teclas de flecha arriba y abajo para cambiar de carril. Recoge cartas y correo a lo largo del sendero. Evite cactus, vallas y otros obstáculos. ¡Entrega el correo!',
  },
  'global-candy-cup': {
    ...
    controls: 'Haga clic o toque para moverse entre casas. Recoge dulces y evita obstáculos. ¡Compite contra otros equipos para conseguir la mayor cantidad de golosinas antes de que termine la noche de Halloween!',
  },
  'magic-cat-academy': {
    ...
    controls: 'Dibuja el símbolo que se muestra encima de cada fantasma con el mouse o el dedo. Haz coincidir la forma con precisión para lanzar el hechizo y derrotar al fantasma. ¡Elimina todos los fantasmas en cada nivel!',
  },
  'google-cat-game': {
  ...
  'doodle-clara-rockmore': {
    ...
    controls: 'Mueva el mouse hacia arriba y hacia abajo para cambiar el tono. Muévase hacia la izquierda y hacia la derecha para controlar el volumen. Intenta tocar con la música en pantalla o crea tus propias melodías.',
  },
  'doodle-scoville': {
    ...
    controls: 'Haz clic para lanzar bolas de helado a los pimientos atacantes. Calcula tus lanzamientos para golpear cada pimiento antes de que te alcance. ¡Sobrevive a través de todos los niveles de calor!',
  },
  'doodle-valentines-day': {
    ...
    controls: 'Haga clic y arrastre los ingredientes para mezclar chocolates. Sigue las recetas y elabora las delicias adecuadas. ¡Sírvelos al interés amoroso del pangolín para progresar!',
  },
  'pangolin-love': {
  ...
  'doodle-cricket-game': {
    ...
    controls: 'Haga clic o toque para balancear el bate mientras se lanza la pelota. Calcula tu clic para golpear la pelota y anotar carreras. ¡No te lo pierdas o quedarás fuera!',
  },
  'doodle-kids-coding': {
    ...
    controls: 'Arrastre y suelte bloques de código direccional en el área de secuencia. Presione el botón de reproducción para ejecutar su programa y observe cómo el conejito sigue sus instrucciones.',
  },
  'birth-of-hip-hop': {
    ...
    controls: 'Haga clic y arrastre el crossfader para mezclar entre tocadiscos. Rasca discos haciendo clic y arrastrando el vinilo. Desbloquea nuevas pistas y ritmos a medida que avanzas.',
  },
  'oskar-fischinger': {
    ...
    controls: 'Haga clic en la cuadrícula para colocar y eliminar formas. Cada forma produce un sonido diferente. Ajusta el tempo, los instrumentos y los efectos para crear tu pieza musical visual.',
  },
  'komodo-national-park': {
    ...
    controls: 'Haga clic en su respuesta para cada pregunta del cuestionario. Conozca datos sobre los dragones de Komodo y su hábitat. ¡Anota tantas respuestas correctas como puedas!',
  },
  'garden-gnomes': {
    ...
    controls: 'Haz clic y mantén presionado para establecer el ángulo de lanzamiento, luego suelta para lanzar el gnomo. Cuanto más aguantes, más poder. ¡Intenta alcanzar la distancia máxima!',
  },
  'halloween': {
    ...
    controls: 'Usa las teclas de flecha o desliza el dedo para mover tu fantasma por el mapa. Recoge llamas espirituales errantes y tráelas de regreso a tu base para anotar. ¡Roba las llamas que se arrastran detrás de los oponentes!',
  },
  'baseball': {
    ...
    controls: 'Haga clic o toque para balancear el bate mientras se lanza la pelota. Calcula tu swing para hacer contacto y golpear la pelota lo más lejos posible. ¡Anota carreras para tu equipo!',
  },
  'doodle-loteria': {
    ...
    controls: 'Haga clic en las tarjetas correspondientes en su tablero a medida que las diga. Complete una fila, columna o patrón para llamar "¡Lotería!" y ganar la ronda.',
  },
  'celebrating-bach': {
    ...
    controls: 'Haz clic en el pentagrama para colocar notas y crear tu melodía. Presione el botón "Armonizar" para permitir que la IA agregue un acompañamiento estilo Bach. ¡Escucha tu creación!',
  },
  'doodle-earth-day': {
    ...
    controls: 'Utilice las teclas de flecha o haga clic para guiar a la abeja entre las flores. Aterriza sobre flores para recolectar polen y luego visita otras flores para polinizarlas. ¡Ayuda a que todo el jardín florezca!',
  },
  'magic-cat-academy-2': {
    ...
    controls: 'Dibuja el símbolo que se muestra encima de cada fantasma con el mouse o el dedo. Los nuevos enemigos submarinos requieren diferentes patrones de hechizos. ¡Derrota a todos los fantasmas para superar cada nivel!',
  },
  'doodle-mbira': {
    ...
    controls: 'Haga clic en los dientes de mbira para tocar notas. Sigue la melodía guiada o crea tu propia composición. Experimente con diferentes ritmos y patrones.',
  },
  'doodle-history-of-pizza': {
    ...
    controls: 'Dibuja líneas con el ratón para cortar la pizza en el número correcto de trozos iguales. Haga coincidir el orden que se muestra en la parte superior. ¡Sea preciso para obtener la mejor puntuación!',
  },
  'wewa-weaving': {
    ...
    controls: 'Haz clic en el telar para tejer hilos a través de la urdimbre. Seleccione diferentes colores y patrones. Complete el tejido para revelar un hermoso diseño textil tradicional.',
  },
  'champion-island-games': {
    ...
    controls: 'Usa las teclas de flecha para mover a tu personaje. Interactúa con los NPC presionando la barra espaciadora. Cada deporte tiene controles únicos: sigue el tutorial del juego para cada evento.',
  },
  'doodle-valentines-day-2022': {
    ...
    controls: 'Haga clic o toque para interactuar con los elementos del rompecabezas. Guía a los hámsters a través de cada nivel resolviendo obstáculos. ¡Reúne a la pareja de hámsters!',
  },
  'celebrating-petanque': {
    ...
    controls: 'Haz clic y arrastra para establecer el ángulo y la potencia de tu lanzamiento. Suelte para lanzar la bola. ¡Intenta aterrizar lo más cerca posible del cochonnet (bola objetivo)!',
  },
  'boba-bubble-tea': {
    ...
    controls: 'Haz clic en los ingredientes para agregarlos a tu bebida. Elija su base de té, sabor, aderezos y tipo de boba. ¡Mezcla todo para crear tu té de burbujas perfecto!',
  },
  'celebrating-pani-puri': {
    ...
    controls: 'Haga clic para sacar y llenar cada puri con la combinación correcta de agua y chutneys. Sirva el pani puri terminado a los clientes antes de que se vayan. ¡No los dejes esperar!',
  },
  'celebrating-lake-xochimilco': {
    ...
    controls: 'Haz clic o toca para guiar al ajolote a través de los canales. Interactúa con el medio ambiente y aprende sobre el ecosistema único de jardines flotantes del lago Xochimilco.',
  },
  'celebrating-popcorn': {
    ...
    controls: 'Haga clic o toque para hacer estallar los granos en el momento adecuado. Atrapa las palomitas de maíz en tu balde moviéndote hacia la izquierda y hacia la derecha. ¡Obtén puntos de bonificación por atrapar piezas sazonadas!',
  },
  'magic-cat-academy-3': {
    ...
    controls: 'Dibuja el símbolo que se muestra encima de cada fantasma con el mouse o el dedo. Los nuevos tipos de fantasmas requieren nuevos patrones de hechizos. ¡Derrota a todos los fantasmas para superar cada nivel!',
  },
  'rise-of-the-half-moon': {
    ...
    controls: 'Haz clic para seleccionar y jugar cartas de tu mano. Equilibra las cartas de sol y luna para crear combos poderosos. ¡Supera a tu oponente para ganar cada ronda!',
  },
  'chinese-new-year-snake': {
    ...
    controls: 'Utilice las teclas de flecha o deslice el dedo para cambiar la dirección de la serpiente. Recoge elementos para crecer mientras evitas las paredes y tu propia cola.',
  },
  'doctor-who': {
    ...
    controls: 'Haga clic para mover al Doctor por cada nivel. Recoge objetos y úsalos para resolver acertijos. ¡Evita a los Daleks y otros enemigos!',
  },
  'chrome-dino': {
    ...
    controls: 'Presiona la barra espaciadora o toca para saltar sobre los cactus. Pulsa la flecha hacia abajo para agacharte bajo los pterodáctilos. ¡El juego se vuelve más rápido a medida que aumenta tu puntuación!',
  },
  't-rex-run-3d': {
    title: 'T-Rex Run 3D',
    ...
    controls: 'Pulsa la barra espaciadora para saltar y la flecha hacia abajo para agacharte. Usa las flechas izquierda y derecha para esquivar en 3D. ¡Recoge monedas y potenciadores para obtener puntos de bonificación!',
  },
  'dino-swords': {
    title: 'Dino Swords',
    ...
    controls: 'Pulsa la barra espaciadora para saltar y recoger armas. Úselos automáticamente para destruir obstáculos. ¡Cada arma tiene un número limitado de usos!',
  },
  'blob-opera': {
    title: 'Blob Opera',
    ...
    controls: 'Haga clic y arrastre las manchas hacia arriba y hacia abajo para cambiar el tono, hacia la izquierda y hacia la derecha para cambiar los sonidos de las vocales. ¡Mueve las cuatro burbujas para crear arreglos de ópera armoniosos!',
  },
  'google-feud': {
    title: 'Google Feud',
    ...
    controls: 'Lea la consulta de búsqueda parcial de Google y escriba su suposición sobre cómo se completa automáticamente. Obtenga puntos por hacer coincidir sugerencias de búsqueda populares. ¡Juega en múltiples rondas!',
  },
  'quick-draw': {
    title: 'Quick, Draw!',
    ...
    controls: 'Dibuje el objeto solicitado en el lienzo con el mouse o el dedo en 20 segundos. ¡La IA intentará adivinar lo que estás dibujando en tiempo real!',
  },
  'chrome-music-lab': {
    ...
    controls: 'Haga clic en cualquiera de los experimentos musicales para explorar. Cada herramienta tiene diferentes interacciones: haga clic, arrastre y reproduzca para crear música y descubrir cómo funciona el sonido.',
  },
  'google-maps-snake': {
    ...
    controls: 'Utilice las teclas de flecha para navegar con su vehículo por las calles de la ciudad. Recoge pasajeros para crecer más. ¡Evita golpearte o salirte del mapa!',
  },
  'google-earth': {
    title: 'Google Earth',
    ...
    controls: 'Haga clic y arrastre para rotar el globo. Desplácese para acercar y alejar. Haga doble clic en cualquier ubicación para volar allí. Utilice la barra de búsqueda para encontrar lugares específicos.',
  },
  'santa-tracker': {
    ...
    controls: 'Haz clic en diferentes juegos y actividades en Santa\'s Village. Cada minijuego tiene sus propios controles: ¡sigue las instrucciones en pantalla!',
  },
  'space-invaders': {
    ...
    controls: 'Utilice las teclas de flecha izquierda y derecha para mover su cañón. Pulsa la barra espaciadora para disparar. ¡Destruye a todos los invasores antes de que lleguen al final de la pantalla!',
  },
  'doodle-jump-2': {
    title: 'Doodle Jump 2',
    ...
    controls: 'Utilice las teclas de flecha izquierda y derecha o inclínelo para moverse. El garabato salta automáticamente: guíalo hacia las plataformas. ¡Evita a los enemigos y consigue potenciadores!',
  },
  'google-solitaire': {
    ...
    controls: 'Haga clic o arrastre tarjetas para moverlas entre columnas. Haz clic en el mazo para robar nuevas cartas. Haga doble clic en una tarjeta para enviarla automáticamente a la fundación.',
  },
  'google-spider-solitaire': {
    ...
    controls: 'Arrastra cartas para construir secuencias descendentes del mismo palo. Completa una carrera completa desde Rey hasta As para borrarlo del tablero. Haga clic en la pila de valores para repartir nuevas cartas.',
  },
  'google-freecell': {
    ...
    controls: 'Haz clic para mover cartas entre columnas, celdas libres y pilotes de cimientos. Construya columnas en colores alternos descendentes. Mueve las cartas a las bases en orden ascendente por palo.',
  },
  'google-cricket': {
  ...
  'google-memory': {
    ...
    controls: 'Haga clic en una tarjeta para darle la vuelta. Intenta encontrar la carta correspondiente recordando su posición. ¡Elimina todos los pares para ganar!',
  },
  'google-ludo': {
    title: 'Google Ludo',
    ...
    controls: 'Haz clic para tirar los dados y luego haz clic en una ficha para moverla. Consigue un 6 para poner en juego nuevas fichas. Aterriza sobre tus oponentes para enviarlos de regreso al comienzo.',
  },
  'google-word-coach': {
    ...
    controls: 'Haga clic en la respuesta correcta de las opciones proporcionadas para cada pregunta de palabras. Gana puntos por cada respuesta correcta y aumenta tu racha.',
  },
  'google-spinner': {
    ...
    controls: 'Haz clic y arrastra para hacer girar la ruleta. Cuanto más rápido lo deslices, más rápido girará. Alterna entre los modos fidget spinner y rueda numérica.',
  },
  'google-coin-flip': {
    ...
    controls: 'Haz clic en el botón "Voltear" o toca la moneda para lanzarla. La moneda girará y caerá aleatoriamente en cara o cruz.',
  },
  'google-dice-roller': {
    ...
    controls: 'Haz clic en "Tira" para lanzar los dados. Ajusta el número de dados y lados usando los controles. Los resultados se muestran con una animación rodante satisfactoria.',
  },
  'google-timer': {
    ...
    controls: 'Ingrese una duración de tiempo y haga clic en "Iniciar" para comenzar la cuenta regresiva. Utilice el modo de cronómetro para contar. Pausar, reanudar o restablecer en cualquier momento.',
  },
  'google-metronome': {
    ...
    controls: 'Haga clic en "Iniciar" para comenzar el ritmo. Ajuste el tempo usando el control deslizante BPM o escriba los tiempos por minuto que desee. Haga clic en "Detener" para pausar.',
  },
  'zerg-rush': {
    title: 'Zerg Rush',
    ...
    controls: 'Haz clic rápidamente en los caracteres "O" que caen para destruirlos antes de que se coman los resultados de la búsqueda. Cada O requiere tres clics para derrotarla. ¡Sobrevive el mayor tiempo posible!',
  },
  'atari-breakout': {
    ...
    controls: 'Mueva el mouse o el dedo hacia la izquierda y hacia la derecha para controlar la paleta. Rebota la pelota para romper todos los ladrillos de arriba. ¡No dejes que la pelota pase de tu pala!',
  },
  'google-gravity': {
    ...
    controls: 'Haga clic y arrastre cualquier elemento de la página para recogerlo y lanzarlo. Observa cómo todo cae y rebota con física realista. ¡Intenta buscar algo!',
  },
  'thanos-snap': {
    title: 'Thanos Snap',
    ...
    controls: 'Haz clic en el icono de Infinity Gauntlet para realizar el ajuste. Observe cómo la mitad de los resultados se desintegran en polvo. Haga clic nuevamente para revertir el ajuste y restaurar todo.',
  },
  'super-mario-coin-block': {
    ...
    controls: 'Haz clic o toca el bloque del signo de interrogación para golpearlo y liberar monedas. Sigue haciendo clic para recolectar tantas monedas como sea posible. ¡Escuche el clásico sonido de la moneda!',
  },
  'google-pac-man': {
  ...
  'google-mirror': {
    ...
    controls: 'Escribe en la barra de búsqueda para ver tu texto aparecer reflejado. Navega por la interfaz invertida para disfrutar de una experiencia increíble. ¡Todos los enlaces y botones funcionan al revés!',
  },
  'google-in-1998': {
    ...
    controls: 'Escriba una consulta de búsqueda en la clásica barra de búsqueda de estilo 1998 y presione Entrar. Navegue por la nostálgica página de resultados. Haga clic para explorar la interfaz antigua.',
  },
  'do-a-barrel-roll': {
    ...
    controls: 'Haga clic en el botón para activar la animación del giro del barril. Toda la página girará 360 grados. ¡Haz clic varias veces para disfrutar de una diversión continua!',
  },
  'google-askew': {
    ...
    controls: 'Simplemente observe la página inclinada e intente usarla normalmente. Busque, haga clic en enlaces y explore, todo desde un ángulo peculiar. Actualice para ver la inclinación nuevamente.',
  },
  'friends-easter-eggs': {
    ...
    controls: 'Haz clic en el ícono de cada personaje para activar su animación única del huevo de Pascua. Explora los seis personajes para descubrir cada sorpresa oculta y eslogan icónico.',
  },
  'google-underwater': {
    ...
    controls: 'Mueve el ratón para interactuar con la escena submarina. Haz clic para crear ondas y asustar a los peces. Arrastra los elementos y observa cómo flotan en el agua.',
  },
  'google-space': {
    title: 'Google Space',
    ...
    controls: 'Haz clic y arrastra cualquier elemento para lanzarlo por el espacio. Observa cómo los objetos flotan y chocan con la física de gravedad cero. Intente escribir en la barra de búsqueda mientras todo desaparece.',
  },
  'google-tetris': {
    title: 'Google Tetris',
    ...
    controls: 'Utilice las teclas de flecha izquierda y derecha para mover piezas. Presione la flecha hacia arriba para rotar. Presione la flecha hacia abajo para una caída suave y la barra espaciadora para una caída fuerte. ¡Líneas claras para anotar!',
  },
  'google-2048': {
    title: 'Google 2048',
    ...
    controls: 'Utilice las teclas de flecha o deslice el dedo para deslizar todos los mosaicos en una dirección. Los números coincidentes se fusionan cuando chocan. ¡Planifica tus movimientos con cuidado para evitar llenar el tablero!',
  },
  'google-interland': {
    ...
    controls: 'Utilice las teclas de flecha o haga clic para navegar por cada zona. Responda preguntas y complete desafíos para ganar puntos. Avanza por los cuatro reinos para dominar la seguridad en Internet.',
  },
  'google-arts-culture-face-match': {
    ...
    controls: 'Permita el acceso a la cámara y tome una selfie haciendo clic en el botón de captura. La IA escaneará las colecciones del museo y mostrará su arte más cercano junto con la historia de la pintura.',
  },
  'google-teachable-machine': {
    ...
    controls: 'Haga clic en "Entrenar" para grabar muestras para cada clase usando su cámara web o micrófono. Agrega varias clases y luego haz clic en "Entrenar modelo" para crear tu IA. ¡Pruébalo en tiempo real!',
  },
  'great-ghoul-duel-2': {
    ...
    controls: 'Usa las teclas de flecha o desliza el dedo para mover tu fantasma. Recoge llamas espirituales y devuélvelas a tu base. ¡Usa nuevos potenciadores para obtener ventaja sobre el equipo contrario!',
  },
  'doodle-solitaire': {
  ...
  'gerald-lawson-game-maker': {
    ...
    controls: 'Usa el editor de niveles para colocar plataformas, enemigos y potenciadores. Haz clic en "Reproducir" para probar tu creación. ¡Comparte tus niveles personalizados con amigos!',
  },
  'valentines-day-chemistry': {
    ...
    controls: 'Haga clic y arrastre elementos para combinarlos y desencadenar reacciones químicas. Combina los pares correctos para desbloquear animaciones con temas de amor y completar el rompecabezas.',
  },
  'rise-of-the-half-moon-november': {
    ...
    controls: 'Haz clic y arrastra para interactuar con las fases lunares. Resuelve acertijos alineando objetos celestes. Avanza a través de la historia completando cada desafío.',
  },
  ...
  'rise-of-the-half-moon-january': {
    ...
    controls: 'Haz clic y arrastra para interactuar con las fases lunares. Resuelve los acertijos finales alineando objetos celestes. ¡Completa la saga!',
  },
  ...
  'minecraft-easter-egg': {
    ...
    controls: 'Utilice WASD para moverse y el mouse para mirar a su alrededor. Haga clic izquierdo para romper bloques, haga clic derecho para colocar bloques. Teclas numéricas para seleccionar diferentes tipos de bloques de su inventario.',
  },
  ...
  'google-maps-pac-man': {
    ...
    controls: 'Utilice las teclas de flecha para guiar a PAC-MAN por las calles de la ciudad real. Cómete todos los puntos evitando los fantasmas. ¡Coge perdigones de energía para darle la vuelta a tus perseguidores!',
  },
  'google-whirlybird': {
    ...
    controls: 'Haz clic o toca para hacer que el helicóptero vuele hacia arriba. Suelte para dejarlo descender. ¡Navega a través de espacios entre obstáculos sin chocar!',
  },
  'rugby-world-cup-2015': {
    ...
    controls: 'Haz clic para patear la pelota y sumar puntos. Programe sus conversiones y elimine objetivos. ¡Corre con el balón y esquiva a los defensores para anotar intentos!',
  },
  ...
  'tetris': {
    title: 'Tetris',
    description: 'El legendario juego de bloques que definió una generación. Rota y desliza los tetrominos para crear líneas horizontales completas que desaparecen — evitando que tu pila llegue a la cima.\n\nDiseñado por el ingeniero soviético Alexey Pajitnov en 1984, Tetris es uno de los juegos más vendidos de todos los tiempos con más de 520 millones de copias.',
    controls: 'Teclas de flecha: ← → para deslizar, ↑ para rotar, ↓ para caída lenta. Espacio para caída rápida. Completa filas sin huecos.',
  },
  'pong': {
    title: 'Pong',
    description: 'El clásico arcade original que lanzó toda una industria. Controla tu paleta para enviar la pelota al campo contrario.\n\nDesarrollado por Atari en 1972, Pong fue el primer videojuego comercialmente exitoso.',
    controls: 'Mueve la paleta con el ratón o W / S. El primero en llegar a 7 puntos gana.',
  },
  'breakout': {
    title: 'Breakout',
    description: 'Rompe filas de coloridos ladrillos con una pelota y una paleta.\n\nDiseñado por Nolan Bushnell en 1976, el prototipo hardware fue construido por Steve Jobs y Steve Wozniak en solo cuatro días.',
    controls: 'Mueve la paleta con ← → o el ratón. Mantén la pelota en juego y apunta a los ladrillos.',
  },
  '2048': {
    title: '2048',
    description: 'Desliza fichas numeradas en una cuadrícula de 4×4, fusionando números idénticos para crear valores mayores. Tu objetivo: alcanzar la ficha 2048.\n\nCreado por el italiano Gabriele Cirulli en marzo de 2014, con tan solo 19 años.',
    controls: 'Desliza o usa ← → ↑ ↓ para mover todas las fichas. Las fichas iguales se fusionan. Alcanza el 2048.',
  },
  'sudoku': {
    title: 'Sudoku',
    description: 'Rellena la cuadrícula de 9×9 para que cada fila, columna y caja 3×3 contenga los dígitos 1–9 exactamente una vez.\n\nA pesar de su nombre japonés, el Sudoku fue inventado en EE.UU. por Howard Garns en 1979.',
    controls: 'Haz clic en una celda vacía y escribe un número (1–9). Elige la dificultad y resuelve el puzle.',
  },
  'word-search': {
    title: 'Sopa de Letras',
    description: 'Encuentra palabras ocultas en una cuadrícula de letras — busca horizontal, vertical, diagonal e incluso al revés. Compite contra el reloj para encontrar todas las palabras antes de que se acabe el tiempo.\n\nLos puzzles de sopa de letras fueron inventados por Norman E. Gibat en 1968. Hoy cientos de millones de personas los resuelven a diario en todo el mundo.',
    controls: 'Haz clic en la primera y última letra de una palabra para resaltarla. Las palabras pueden ir en cualquier dirección. Tacha cada palabra de la lista para completar el puzzle.',
  },
  'word-scramble': {
    title: 'Palabras Revueltas',
    description: 'Descifra las letras desordenadas para revelar la palabra oculta lo más rápido posible. Un juego de vocabulario que pone a prueba tu instinto ortográfico bajo presión.\n\nLos juegos de palabras revueltas aprovechan una fascinante peculiaridad cerebral: el cerebro puede reconocer palabras con las letras centrales desordenadas si la primera y la última están en su lugar.',
    controls: 'Lee las letras desordenadas en pantalla. Escribe tu respuesta en el cuadro de texto y pulsa Enter para confirmar.',
  },
  'connect-four': {
    title: 'Conecta Cuatro',
    description: 'Deja caer discos de colores en una cuadrícula vertical y sé el primero en alinear cuatro de tu color — horizontal, vertical o diagonalmente. Simple en apariencia, profundo en estrategia.\n\nConecta Cuatro fue resuelto matemáticamente en 1988: el primer jugador siempre puede garantizar la victoria comenzando por la columna central.',
    controls: 'Haz clic en una columna para soltar tu disco. Los discos caen a la posición más baja disponible. Sé el primero en conectar cuatro discos de tu color para ganar.',
  },
  'sliding-puzzle': {
    title: 'Puzle Deslizante',
    description: 'Desliza fichas numeradas en una cuadrícula de 4×4 (con un espacio vacío) para ordenarlas del 1 al 15. Piensa varias jugadas por adelantado para resolverlo con menos movimientos.\n\nEl puzzle del 15 desató una locura mundial en la década de 1880. Matemáticamente, exactamente la mitad de todas las posiciones barajadas son imposibles de resolver.',
    controls: 'Haz clic en una ficha adyacente al espacio vacío para deslizarla. Sigue reorganizando hasta que todas estén ordenadas del 1 al 15.',
  },
  'flappy-bird': {
    title: 'Flappy Bird',
    description: 'Toca para batir las alas de tu pájaro y navega por una serie interminable de huecos entre tuberías. Cada toque eleva al pájaro ligeramente; la gravedad lo arrastra sin piedad.\n\nCreado por el desarrollador vietnamita Dong Nguyen en 2013, Flappy Bird se convirtió en un fenómeno mundial que ganaba 50.000 dólares diarios en publicidad antes de que su creador lo retirara voluntariamente.',
    controls: 'Pulsa Espacio o haz clic en cualquier lugar para batir las alas. Guía al pájaro a través de los huecos entre las tuberías sin tocarlas.',
  },
  'space-invaders-online': {
    title: 'Space Invaders',
    description: 'Defiende la Tierra de oleadas de invasores alienígenas descendentes. Mueve tu cañón láser y destruye a los alienígenas antes de que lleguen al suelo.\n\nCreado por Tomohiro Nishikado en 1978, Space Invaders causó una escasez nacional de monedas de 100 yenes en Japón debido a su enorme popularidad.',
    controls: 'Usa ← → para mover tu cañón. Pulsa Espacio para disparar. Destruye todos los alienígenas antes de que lleguen abajo. Los OVNIs dan puntos extra.',
  },
  'asteroids': {
    title: 'Asteroides',
    description: 'Pilota tu nave espacial a través de un campo de asteroides giratorios, destruyéndolos en fragmentos cada vez más pequeños. Esquiva los escombros y vigila los platillos enemigos.\n\nCreado por Atari en 1979, Asteroids fue su máquina recreativa más vendida con más de 70.000 unidades en todo el mundo.',
    controls: '← → para girar, ↑ para propulsar y Espacio para disparar. Los asteroides grandes se dividen en medianos y luego en pequeños. Esquiva los platillos voladores.',
  },
  'frogger': {
    title: 'Frogger',
    description: 'Guía a tu rana a cruzar una carretera concurrida y un río peligroso para llegar a casa sana y salva. Esquiva coches, camiones y autobuses, luego salta sobre troncos y tortugas.\n\nDiseñado por Konami en 1981, Frogger vendió más de 20 millones de unidades y se considera uno de los primeros comentarios ambientales de la historia de los videojuegos.',
    controls: 'Usa las flechas para mover la rana paso a paso. Cruza la carretera calculando los huecos del tráfico. Usa troncos y tortugas para cruzar el río.',
  },
  'galaga': {
    title: 'Galaga',
    description: 'Combate oleada tras oleada de formaciones alienígenas en este icónico shooter espacial. Los enemigos atacan en formación y un rayo tractor puede capturar tu nave.\n\nLanzado por Namco en 1981, Galaga es considerado uno de los mejores juegos arcade jamás creados en la historia de los videojuegos.',
    controls: '← → para mover la nave. Espacio para disparar. Deja que el Boss Galaga capture tu nave, luego derrótalo para recuperarla y luchar con doble potencia.',
  },
  'brick-breaker': {
    title: 'Rompeladrillos',
    description: 'Rompe capas de ladrillos con una pelota rebotante y una paleta. Recoge potenciadores — paletas más largas, multi-bola, disparos láser — y elimina todos los ladrillos para avanzar.\n\nBrick Breaker es el sucesor espiritual del clásico Breakout, manteniendo vivo el género de la pelota rebotante durante casi 50 años.',
    controls: 'Mueve la paleta con el ratón o ← →. Mantén la pelota rebotando y apunta a los ladrillos. Recoge los potenciadores. Elimina todos los ladrillos para avanzar.',
  },
  'stack-tower': {
    title: 'Torre de Pilas',
    description: 'Toca para cortar y apilar bloques mientras se balancean de un lado a otro. Cada parte sobresaliente se corta, estrechando tu plataforma. ¿Qué tan alto puedes construir?\n\nStack Tower explota el anhelo del cerebro por la precisión y el ritmo, creando tensión instantánea con un bucle simple: balanceo → toque → alineación.',
    controls: 'Pulsa Espacio o haz clic para cortar el bloque en movimiento. Cuanto más precisa la alineación, más ancha queda la plataforma. Apila lo más alto posible.',
  },
  'reaction-time': {
    title: 'Test de Reacción',
    description: '¡Cuando la pantalla se ponga verde, haz clic lo más rápido que puedas! Tu tiempo de reacción se registra en milisegundos — una forma científica de medir tus reflejos.\n\nEl tiempo de reacción humano promedio es de unos 250 milisegundos. Los atletas entrenados promedian 150 ms. Los pilotos de Fórmula 1 pueden reaccionar en menos de 100 ms.',
    controls: 'Espera a que la pantalla cambie de rojo a verde y haz clic lo más rápido posible. El cronómetro mide el tiempo exacto entre el cambio de color y tu clic. ¡No hagas clic antes!',
  },
  'whack-a-mole': {
    title: 'Golpea al Topo',
    description: 'Los topos siguen asomándose por sus agujeros — ¡golpea tantos como puedas antes de que se escondan! Con cada nivel los topos son más rápidos y las ventanas de reacción se reducen.\n\nWhac-A-Mole (originalmente "Mogura Taiji") fue inventado por el desarrollador japonés TOGO en 1975 y sigue siendo un clásico arcade en todo el mundo.',
    controls: 'Haz clic o toca un topo en cuanto asome para golpearlo. Cada golpe exitoso suma un punto. ¡Golpea tantos como puedas en 30 segundos!',
  },
  'dots-and-boxes': {
    title: 'Puntos y Cajas',
    description: 'Toma turnos dibujando líneas entre puntos. Completa el cuarto lado de una caja para reclamarla y jugar de nuevo. El jugador que reclame más cajas gana.\n\nPuntos y Cajas fue inventado por el matemático francés Édouard Lucas en 1889. A pesar de su apariencia infantil, posee una profunda estructura de teoría de juegos combinatoria.',
    controls: 'Haz clic entre dos puntos adyacentes para dibujar una línea. Si tu línea completa una caja, la reclamas y juegas otra vez. Consigue más cajas que tu oponente para ganar.',
  },
  'reversi': {
    title: 'Reversi (Othello)',
    description: 'Coloca discos en el tablero y rodea las piezas de tu oponente para voltearlas a tu color. Un solo movimiento puede voltear filas y columnas enteras — el tablero puede cambiar drásticamente en pocos turnos.\n\nReversi fue inventado en Inglaterra en 1883. La versión moderna Othello (1971) lleva el lema "un minuto para aprender, toda una vida para dominar".',
    controls: 'Haz clic en un cuadrado válido (mostrado en verde) para colocar tu disco. Un movimiento solo es válido si rodea al menos un disco rival. Todos los discos rodeados se voltean. Gana quien tenga más al final.',
  },
