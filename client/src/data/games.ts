...
export const GAMES: Game[] = [
  ...
  // ===== Online Games Collection =====
  {
    ...
    slug: 'tetris',
    title: 'Tetris',
    description: 'The legendary falling-block puzzle game that defined a generation. Guide tetrominoes as they fall, rotating and sliding them to create complete horizontal lines that vanish — keeping your stack from reaching the top. As you clear more lines, the pace quickens and the challenge intensifies.\n\nDesigned by Soviet engineer Alexey Pajitnov in 1984, Tetris is one of the best-selling games of all time with over 520 million copies sold across every platform imaginable. Its simple-yet-deep mechanics have kept players captivated for four decades, earning it a permanent place in the World Video Game Hall of Fame.',
    category: 'online',
    thumbnail: '/thumbnails/online-tetris.jpg',
    iframeUrl: 'https://g.tetrisnow.com/',
    controls: 'Arrow keys to move and rotate pieces: ← → to slide left/right, ↑ to rotate clockwise, ↓ to soft-drop (speed up fall). Press Space to hard-drop the piece instantly to the bottom. Clear lines by filling entire rows with no gaps.',
    difficulty: 'medium',
    isNew: true,
    tags: ['classic', 'arcade', 'keyboard', 'puzzle', 'fast-paced', 'strategy'],
    playCount: 0,
  },
  {
    id: 'o2',
    slug: 'pong',
    title: 'Pong',
    description: 'The original arcade classic that launched an entire industry. Control your paddle to bounce the ball past your opponent — first to score wins. Deceptively simple, endlessly competitive.\n\nDeveloped by Atari and released in 1972, Pong was the first commercially successful video game. These two-player rules that seem so elementary today sparked a billion-dollar industry and set the stage for everything that followed in gaming history.',
    category: 'online',
    thumbnail: '/thumbnails/online-pong.jpg',
    iframeUrl: '/tools/pong.html',
    controls: 'Move your paddle using the mouse or by pressing W / S keys (left paddle). Your opponent is the right paddle. Bounce the ball past their paddle to score a point. First player to 7 points wins the match.',
    difficulty: 'easy',
    isNew: true,
    tags: ['classic', 'arcade', 'multiplayer', 'sports', 'keyboard', 'mouse'],
    playCount: 0,
  },
  {
    id: 'o4',
    slug: '2048',
    title: '2048',
    description: 'Slide numbered tiles across a 4×4 grid, merging identical numbers to create larger ones. Your goal: reach the elusive 2048 tile. But once the board fills with no valid moves, it\'s game over.\n\nCreated by Italian developer Gabriele Cirulli in a single weekend in March 2014 when he was just 19 years old. Within a week it had attracted 4 million players. He open-sourced it for free and it became one of the most cloned games in history — a true accidental phenomenon.',
    category: 'online',
    thumbnail: '/thumbnails/online-2048.jpg',
    iframeUrl: 'https://files.rocketgames.io/uploads/games/2/2048/files/index.html',
    controls: 'Swipe or use the arrow keys (← → ↑ ↓) to slide all tiles simultaneously in that direction. When two tiles with the same number collide, they merge into one tile with their combined value. Combine tiles to reach 2048 and beyond.',
    difficulty: 'medium',
    isNew: true,
    tags: ['puzzle', 'brain', 'strategy', 'keyboard', 'touch-friendly', 'logic'],
    playCount: 0,
  },
  {
    id: 'o5',
    slug: 'sudoku',
    title: 'Sudoku',
    description: 'Fill the 9×9 grid so that every row, column, and 3×3 box contains the digits 1–9 exactly once. A pure logic puzzle — no guessing required. Choose your difficulty and think methodically.\n\nDespite its Japanese name, Sudoku was popularised in Japan in 1986 by puzzle publisher Nikoli. It was originally invented in the USA by Howard Garns in 1979 under the name "Number Place". The worldwide Sudoku craze began in 2004 when The Times of London published it, and it now appears in newspapers in 90+ countries daily.',
    category: 'online',
    thumbnail: '/thumbnails/online-sudoku.jpg',
    iframeUrl: 'https://sudoku-online.github.io/a77/sudoku/',
    controls: 'Click an empty cell and type a number (1–9) to fill it in. Use pencil marks to note possible candidates. Click the difficulty buttons to choose Easy, Medium, or Hard. The timer tracks how fast you solve the puzzle.',
    difficulty: 'hard',
    isNew: true,
    tags: ['puzzle', 'brain', 'logic', 'strategy', 'mouse', 'relaxing'],
    playCount: 0,
  },
  {
    id: 'o6',
    slug: 'word-search',
    title: 'Word Search',
    description: 'Find hidden words in a grid of letters — scan horizontally, vertically, diagonally, and even backwards. Race the clock and hunt every word before time runs out.\n\nThe word search puzzle was invented by Norman E. Gibat in 1968 and first published in the Selenby Digest. Today hundreds of millions of people solve word searches daily, making it one of the most popular puzzle formats worldwide alongside crosswords and Sudoku.',
    category: 'online',
    thumbnail: '/thumbnails/online-word-search.jpg',
    iframeUrl: 'https://html5.gamedistribution.com/c13ee9c06edc4f0a8d7f6f291a7c13d8/',
    controls: 'Click on the first letter of a word, then click the last letter to highlight it. Words can run left, right, up, down, or diagonally — even backwards. Cross off every word in the list to complete the puzzle.',
    difficulty: 'easy',
    isNew: true,
    tags: ['puzzle', 'words', 'brain', 'mouse', 'relaxing', 'kids-friendly'],
    playCount: 0,
  },
  {
    id: 'o8',
    slug: 'connect-four',
    title: 'Connect Four',
    description: 'Drop coloured discs into a vertical grid and be the first player to align four of your colour in a row — horizontally, vertically, or diagonally. Block your opponent while plotting your own winning line.\n\nConnect Four was solved mathematically in 1988: the first player can always guarantee a win with perfect play by starting in the centre column. Despite being "solved", the strategic depth of real gameplay — blocking threats while building your own — makes it as compelling as ever.',
    category: 'online',
    thumbnail: '/thumbnails/online-connect-four.jpg',
    iframeUrl: 'https://lagged.com/api/play/connect-4-tps/',
    controls: 'Click on a column to drop your disc into it. Discs fall to the lowest available position. Be the first to connect four discs of your colour in a horizontal, vertical, or diagonal line. Play against the AI or challenge a friend.',
    difficulty: 'medium',
    isNew: true,
    tags: ['strategy', 'vs-ai', 'classic', 'puzzle', 'mouse', 'kids-friendly'],
    playCount: 0,
  },
  {
    id: 'o9',
    ...
    description: 'Slide numbered tiles around a 4×4 grid (with one empty space) to arrange them in perfect numerical order from 1 to 15. Think several moves ahead — every slide sets off a chain reaction.\n\nThe 15 Puzzle sparked a worldwide craze in the 1880s and was sold in millions. Mathematically, exactly half of all shuffled starting positions are impossible to solve — a famous result proved by mathematicians Johnson and Story in 1879. If your puzzle seems unsolvable, it just might be by design.',
    category: 'online',
    thumbnail: '/thumbnails/online-sliding-puzzle.jpg',
    iframeUrl: 'https://15puzzle.netlify.app/',
    controls: 'Click on any tile adjacent to the empty space to slide it into that space. Keep rearranging tiles until they are in order from 1 to 15 (left to right, top to bottom). Try to solve it in as few moves and as little time as possible.',
    difficulty: 'medium',
    isNew: true,
    tags: ['puzzle', 'brain', 'strategy', 'classic', 'mouse', 'logic'],
    playCount: 0,
  },
  {
    id: 'o10',
    slug: 'flappy-bird',
    title: 'Flappy Bird',
    description: 'Tap to flap your bird\'s wings and navigate through an endless series of pipe gaps. Each tap lifts the bird slightly; gravity pulls it down relentlessly. One touch of a pipe and it\'s over.\n\nCreated by Vietnamese developer Dong Nguyen in just a few days in 2013, Flappy Bird became a global phenomenon earning $50,000 per day in ad revenue at its peak. Nguyen removed it from app stores in 2014 due to its overwhelmingly addictive nature — one of gaming\'s most remarkable and unusual stories.',
    category: 'online',
    thumbnail: '/thumbnails/online-flappy-bird.jpg',
    iframeUrl: 'https://nebez.github.io/floppybird/',
    controls: 'Press Space, tap the screen, or click anywhere to flap the bird\'s wings. The bird falls due to gravity between flaps. Guide it through the gaps between pipes without touching them. Each pipe passed scores one point. How far can you get?',
    difficulty: 'hard',
    isNew: true,
    tags: ['arcade', 'one-button', 'fast-paced', 'endless', 'touch-friendly', 'precision'],
    playCount: 0,
  },
  {
    id: 'o11',
    slug: 'space-invaders-online',
    title: 'Space Invaders',
    description: 'Defend Earth from waves of descending alien invaders! Move your laser cannon left and right, blast the aliens before they reach the ground, and take cover behind destructible bunkers.\n\nCreated by Tomohiro Nishikado in 1978, Space Invaders was such a phenomenon in Japan that it caused a national shortage of 100-yen coins. It propelled the Japanese arcade industry to ¥50 billion and became one of the most influential games ever made, directly inspiring the entire shoot-\'em-up genre.',
    category: 'online',
    thumbnail: '/thumbnails/online-space-invaders-online.jpg',
    iframeUrl: 'https://buckyz.github.io/SpaceInvaders/',
    controls: 'Use the ← → arrow keys (or A / D) to move your cannon left and right. Press Space to fire a laser shot. Destroy all the aliens before they reach the bottom. Watch for UFOs crossing the top for bonus points. Take cover behind the bunkers but they erode when hit.',
    difficulty: 'medium',
    isNew: true,
    tags: ['classic', 'arcade', 'shooter', 'keyboard', 'action', 'sci-fi'],
    playCount: 0,
  },
  {
    id: 'o12',
    slug: 'asteroids',
    title: 'Asteroids',
    description: 'Pilot your spaceship through a field of tumbling asteroids, blasting them into smaller and smaller fragments until they are destroyed. Dodge incoming debris and watch for enemy saucers.\n\nCreated by Lyle Rains and Ed Logg at Atari in 1979, Asteroids featured revolutionary vector graphics and became Atari\'s best-selling arcade cabinet with over 70,000 units sold. The game\'s wraparound screen — where objects exit one side and reappear on the other — was a groundbreaking design choice that gave the game its distinctive feel.',
    category: 'online',
    thumbnail: '/thumbnails/online-asteroids.jpg',
    iframeUrl: 'https://www.coolmathgames.com/sites/default/files/public_games/40444/?gd_sdk_referrer_url=https%3A%2F%2Fwww.coolmathgames.com%2F0-asteroids',
    controls: 'Press ← → to rotate the ship, ↑ to thrust forward, and Space to fire. Press H for hyperspace (random teleport). Large asteroids split into medium ones, then small ones — destroy them all to clear the level. Avoid the flying saucers that appear mid-level.',
    difficulty: 'medium',
    isNew: true,
    tags: ['classic', 'arcade', 'shooter', 'keyboard', 'action', 'sci-fi'],
    playCount: 0,
  },
  {
    ...
    slug: 'frogger',
    title: 'Frogger',
    description: 'Guide your frog safely across a busy highway and a treacherous river to reach home. Dodge cars, trucks, and buses, then hop across logs and lily pads without falling into the water.\n\nDesigned by Konami and released in 1981, Frogger was subtly one of gaming\'s first environmentalist statements — a frog navigating a world dominated by human traffic and infrastructure. It sold over 20 million units across all platforms and remains an enduring symbol of classic arcade gaming.',
    category: 'online',
    thumbnail: '/thumbnails/online-frogger.jpg',
    iframeUrl: 'https://unblocked-games.org/games/frogger/',
    controls: 'Use the arrow keys (↑ ↓ ← →) to move your frog one step at a time. Cross the road by timing the gaps between vehicles. Use logs, turtles, and lily pads to cross the river — don\'t fall in or land on a crocodile! Reach all five home spots to advance.',
    difficulty: 'medium',
    isNew: true,
    tags: ['classic', 'arcade', 'keyboard', 'action', 'precision', 'timing'],
    playCount: 0,
  },
  {
    id: 'o14',
    slug: 'galaga',
    title: 'Galaga',
    description: 'Battle wave after wave of alien formations in this iconic space shooter. Enemies swoop in attack dives, and a tractor beam can capture your ship — but recapture it to fight with double firepower.\n\nReleased by Namco in 1981 as the sequel to Galaxian, Galaga is considered one of the greatest arcade games ever made. The famous "double ship" mechanic — deliberately letting an enemy capture your fighter, then shooting the captor to recover it — became one of gaming\'s most celebrated strategies.',
    category: 'online',
    thumbnail: '/thumbnails/online-galaga.jpg',
    iframeUrl: 'https://ubg89.github.io/Galaga/',
    controls: 'Move your ship left and right with the ← → arrow keys or A / D. Press Space or Z to fire. Shoot the boss Galaga\'s tractor beam to free your captured ship and fight as a dual-ship. Kill all enemies in a stage to advance. Watch for bonus challenge stages.',
    difficulty: 'hard',
    isNew: true,
    tags: ['classic', 'arcade', 'shooter', 'keyboard', 'action', 'sci-fi', 'fast-paced'],
    playCount: 0,
  },
  {
    id: 'o15',
    slug: 'brick-breaker',
    title: 'Brick Breaker',
    description: 'Smash through multi-layered bricks with a bouncing ball and paddle. Collect power-ups — longer paddles, multi-ball, laser shots — and clear every brick to advance through increasingly challenging levels.\n\nBrick Breaker is the evolved spiritual successor to the classic Breakout. Modern versions add power-ups, multiple balls, and varied brick types that have made this genre enduringly popular. It remains one of the most-played casual game formats, appearing on every platform from arcade cabinets to smartphones.',
    category: 'online',
    thumbnail: '/thumbnails/online-brick-breaker.jpg',
    iframeUrl: 'https://data.unblockedgamers.com/file/h5games/onlinegames/games/2022/q4/brick-breaker/index.html',
    controls: 'Move the paddle left and right with the mouse or ← → arrow keys. Keep the ball bouncing and aim it at the bricks to destroy them. Collect falling power-ups for special abilities. Clear all bricks on each level to progress. Missing the ball costs a life.',
    difficulty: 'easy',
    isNew: true,
    tags: ['arcade', 'classic', 'keyboard', 'mouse', 'fast-paced', 'action'],
    playCount: 0,
  },
  {
    id: 'o16',
    slug: 'stack-tower',
    title: 'Stack Tower',
    description: 'Tap to slice and stack blocks as they swing back and forth. Land each block perfectly on the one below — any overhanging portion gets cut off, making your platform narrower with every miss. How high can you build?\n\nStack Tower\'s satisfying mechanic exploits the human brain\'s craving for precision and rhythm. The game creates instant tension through a simple loop: swing → tap → align. Perfection feels rewarding; near-misses feel heartbreaking. It\'s one of mobile gaming\'s most elegant and addictive concepts.',
    category: 'online',
    thumbnail: '/thumbnails/online-stack-tower.jpg',
    iframeUrl: 'https://riseuplabs.com/play/stack/',
    controls: 'Press Space, tap, or click to slice the moving block onto the stack. The more precisely you align it, the wider your platform stays. Overhanging portions are cut off, narrowing the block. A perfect hit keeps the full width. Stack as high as possible without reducing to nothing.',
    difficulty: 'medium',
    isNew: true,
    tags: ['arcade', 'one-button', 'timing', 'fast-paced', 'precision', 'touch-friendly'],
    playCount: 0,
  },
  {
    id: 'o17',
    ...
    description: 'When the screen turns green, click as fast as you can! Your reaction time is recorded in milliseconds — a simple but scientific way to test your reflexes and compare against the human average.\n\nThe average human reaction time is approximately 250 milliseconds (0.25 seconds). Trained athletes average around 150ms. Formula 1 drivers react to unexpected events in as little as 100ms. Factors like sleep deprivation, age, caffeine, and screen brightness can all measurably affect your score.',
    category: 'online',
    thumbnail: '/thumbnails/online-reaction-time.jpg',
    iframeUrl: 'https://www.justpark.com/creative/reaction-time-test/',
    controls: 'Wait for the screen to change from red to green, then click as fast as you can. A timer measures the exact time between the colour change and your click. Try multiple attempts and average your results. Don\'t click before it turns green — that\'s a false start!',
    difficulty: 'easy',
    isNew: true,
    externalOnly: true,
    tags: ['brain', 'timing', 'mouse', 'one-button', 'fast-paced', 'action'],
    playCount: 0,
  },
  {
    id: 'o18',
    slug: 'whack-a-mole',
    title: 'Whack-a-Mole',
    description: 'Moles keep popping up from their holes — whack as many as you can before they duck back down! With each level the moles get faster and the time you have to react shrinks. How many can you bop?\n\nWhac-A-Mole (originally "Mogura Taiji" — Mole Buster) was invented by Japanese game developer TOGO in 1975. The original arcade machines used real rubber mallets and remain a staple of arcades worldwide. The game is a timeless test of coordination and reaction speed beloved by all ages.',
    category: 'online',
    thumbnail: '/thumbnails/online-whack-a-mole.jpg',
    iframeUrl: 'https://html5.gamedistribution.com/130ad5176d834d0c87b572101a8c0538/',
    controls: 'Click or tap on a mole as soon as it pops out of its hole to whack it. Moles disappear quickly so you need fast reflexes. Each successful whack earns a point. If a mole escapes without being whacked, you miss the point. Keep whacking for 30 seconds!',
    difficulty: 'easy',
    isNew: true,
    tags: ['arcade', 'mouse', 'kids-friendly', 'fast-paced', 'action', 'timing'],
    playCount: 0,
  },
  {
    id: 'o19',
    ...
    description: 'Take turns drawing lines between dots on a grid. Complete the fourth side of a box to claim it and take another turn. The player who claims the most boxes wins. Looks simple — plays deep.\n\nDots and Boxes was invented by French mathematician Édouard Lucas in 1889 and first published with strategic analysis. Despite its childlike appearance, it has deep combinatorial game theory structure. Expert play involves deliberately giving your opponent short chains to avoid triggering long chains that the opponent can claim entirely.',
    category: 'online',
    thumbnail: '/thumbnails/online-dots-and-boxes.jpg',
    iframeUrl: 'https://ubg67.gitlab.io/dots-and-boxes/',
    controls: 'Click between two adjacent dots to draw a line. If your line completes a box (its fourth side), you claim that box and get another turn. Avoid leaving a box with only 3 sides (your opponent will complete it). Claim the most boxes to win.',
    difficulty: 'medium',
    isNew: true,
    tags: ['strategy', 'classic', 'vs-ai', 'puzzle', 'mouse', 'brain'],
    playCount: 0,
  },
  {
    id: 'o20',
    ...
    description: 'Place discs on the board and outflank your opponent\'s pieces to flip them to your colour. One move can flip entire rows and columns — the board can swing dramatically in just a few turns.\n\nReversi was invented in England in 1883. The modern version, Othello, was patented in Japan in 1971 with the memorable tagline "a minute to learn, a lifetime to master." It remains one of the most studied abstract strategy games — even after decades of research, optimal play on a standard 8×8 board has not been fully solved.',
    category: 'online',
    thumbnail: '/thumbnails/online-reversi.jpg',
    iframeUrl: 'https://gamemug.com/app/reversi/',
    controls: 'Click a valid square (shown in green) to place your disc. A move is only valid if it outflanks at least one of your opponent\'s discs in a straight line (horizontal, vertical, or diagonal). All outflanked discs flip to your colour. The player with the most discs at the end wins.',
    difficulty: 'hard',
    isNew: true,
    tags: ['strategy', 'classic', 'vs-ai', 'puzzle', 'mouse', 'brain', 'logic'],
    playCount: 0,
  },
];
...
export const CATEGORIES: Category[] = [
  ...
  { id: 'online', labelKey: 'category.online', emoji: '🌐' },
];
