            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={sortMenuRef}>
                <button
                  ...
                  className="flex items-center gap-2 px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm font-medium text-slate-600 dark:text-slate-300 hover:border-teal-300 hover:text-teal-600 transition-all shadow-sm whitespace-nowrap"
                >
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center gap-2.5 px-4 py-2.5 text-sm transition-colors ${
                            sortBy === opt ? 'bg-teal-50 dark:bg-teal-950 text-teal-700 dark:text-teal-300 font-semibold' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'
                          }`}
                        >
                          <span>{icons[opt]}</span>
              ...
              <div className="relative w-full sm:w-64">
                ...
                placeholder={t('home.searchPlaceholder')}
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-700 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all"
                />
              </div>
            </div>
          </div>
                ...
                return (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg text-sm font-bold transition-all duration-150 ${
                      hasGames
                        ? "bg-white dark:bg-slate-800 text-teal-600 border border-teal-200 dark:border-teal-500 hover:bg-teal-600 hover:text-white hover:border-teal-600 shadow-sm cursor-pointer"
            ...
            {letters.map((letter) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  <h2 className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-md shadow-teal-200/50 shrink-0">
                  ...
                  {grouped[letter].map((game, idx) => (
                    ...
                    <div className="group relative" onMouseEnter={() => prefetchGameUrl(game.iframeUrl)}>
                      <Link href={`/play/${game.slug}/`}>
                        <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 hover:border-teal-200 dark:hover:border-teal-500 hover:shadow-lg hover:shadow-teal-100/50 dark:hover:shadow-teal-900/30 transition-all duration-300 cursor-pointer flex gap-3 p-3 items-center">
                          {/* Thumbnail */}
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 mb-0.5">
                              <h3 className="font-semibold text-slate-800 dark:text-slate-100 text-sm leading-tight truncate group-hover:text-teal-600 transition-colors">
                                {gt(game).title}
                              </h3>
                              {game.isNew && (
